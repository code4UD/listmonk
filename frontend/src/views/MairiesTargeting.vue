      ...
      <div class="column is-8">
        <div class="box">
          ...
          <div v-show="activeTab === 'map'" class="map-container">
            <div id="france-map" class="map"></div>
            <div v-if="!searchResults" class="map-placeholder">
              ...
              >
                ...
                <template #detail="props">
                  <div class="content">
                    ...
                    <p><strong>{{ $t('mairies.targeting.coordinates') }}:</strong> 
...
export default {
  ...
  methods: {
    ...
    isRegionSelected(region) {
      return region.departments.every(code => 
        this.filters.departments.some(dept => dept.code === code)
      )
    },
