...
// V5_1_0 performs the DB migrations for French municipalities support.
func V5_1_0(db *sqlx.DB, fs stuffbin.FileSystem, ko *koanf.Koanf, lo *log.Logger) error {
	lo.Println("Adding French municipalities support tables...")
	...
	lo.Println("French municipalities tables created successfully")
	return nil
}